...
import { usePostRegistrMutation } from "../../reducer/api/crud/login";
const Registr = () => {
	...
	return (
		<div className={scss.registrPages}>
			<div className="container">
				<div className={scss.content}>
					...
					<div className={scss.forms}>
						<h1>регистрация</h1>
						<div className={scss.inputsAndButton}>
							...
							<div className={scss.inputs}>
								...
								<Input
									type="url"
									value={userPhoto}
									setData={setUserPhoto}
									placeholder="Photo User..."
								/>
							</div>
							<button className={scss.button1} onClick={handlePostUsers}>
								регистрация
							</button>
							<button
